...
const data = [
  { name: 'Pegawai', value: 5, color: '#00d4bd' },
  { name: 'Kegiatan', value: 5, color: '#826bf8' }
]
...
const RechartsPieChart = () => {
  return (
    <Card>
      <CardHeader title='Statistik Kegiatan Pegawai per Bidang pada Hari Ini' />
      <CardContent>
        <Box sx={{ height: 350 }}>
          <ResponsiveContainer>
        ...
        <Box sx={{ display: 'flex', flexWrap: 'wrap', mb: 4, justifyContent: 'center' }}>
          ...
          >
            ...
            <Typography variant='body2'>Pegawai</Typography>
          </Box>
